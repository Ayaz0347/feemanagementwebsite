...
while($row=mysqli_fetch_assoc($result)){?>
    <h2 class="heading-primary">Student Record</h2>
    <div class="plan-section">
      ...
      <br>
        ...
        <br>
        <a href='edit.php?sno=<?php  echo $row['sno']?>' class="btn buy-now">Update</a>
        <a href='delete.php?sno=<?php  echo $row['sno']?>' class="btn buy-now">Delete</a>
      </div>
    </div>
    <?php
}
